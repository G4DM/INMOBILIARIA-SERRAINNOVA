...
export interface SustainabilityChecklist {
    thermalInsulation: {
        climalitWindows: boolean
        sateSystem: boolean
    }
    energySources: {
        aerothermal: boolean
    ...
    waterConsumption: {
        rainwaterRecovery: boolean
    }
    materials: {
        certifiedWood: boolean
        ecologicalPaints: boolean
    }
}
...
export interface Property {
    ...
    description: string
    features: string[]
    sustainabilityChecklist: SustainabilityChecklist
    certifications: string[] // BREEAM, LEED, Passivhaus
}
